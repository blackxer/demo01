...
video = cv2.VideoCapture("/media/zw/DL/ly/workspace/project07/demo01/data/2/2019-11-08 13:17:27.avi")
stabilizer = VideoStabilizer(video)
size = (int(video.get(cv2.CAP_PROP_FRAME_WIDTH)), int(video.get(cv2.CAP_PROP_FRAME_HEIGHT)))
video_writer = cv2.VideoWriter("video_out.avi", cv2.VideoWriter_fourcc(*'MP42'), 25, (640,480))

while True:
    success, ori, frame = stabilizer.read()
    if not success:
